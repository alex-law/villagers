...
def checkVotes():
    ...
    if len(all_alive_wolfs) == 0:
        ...
        response_data = {'html': rendered_template, 'status': 'do_something'}
    ...
    return jsonify({'status': 'do_nothing'})
...
def castVote():
    ...
    # Check if vote_data is not None and then proceed
    ...
    return jsonify({'success': True, 'voted_player': vote})
